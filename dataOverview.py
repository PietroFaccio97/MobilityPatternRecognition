...
bus = readData.retrieveData(Paths.bus)
car = readData.retrieveData(Paths.car)
pedestrian = readData.retrieveData(Paths.pedestrian)
static = readData.retrieveData(Paths.static)
train = readData.retrieveData(Paths.train)
