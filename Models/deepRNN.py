...
# Columns to read
columns = ['ue_ident', 'timestamp', 'phy_ul_pucch_rssi', 'phy_ul_pusch_rssi', 'phy_ul_pucch_sinr', 'phy_ul_pusch_sinr']
ascendingFlags = [True, True, True, True, True, True]
...
model.add(SimpleRNN(20, return_sequences=True, input_shape=[None, 4]))
