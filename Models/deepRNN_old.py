...
model.add(SimpleRNN(3 * len(features), return_sequences=True, input_shape=[None, len(features)]))
model.add(SimpleRNN(3 * len(features), return_sequences=True))
model.add(SimpleRNN(3 * len(features), return_sequences=True))
model.add(SimpleRNN(3 * len(features), return_sequences=True))
model.add(SimpleRNN(3 * len(features)))
